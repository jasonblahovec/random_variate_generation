...
class generate_uniform():
    def __init__(self, n = 1000, seed = 412, mult = 16807, mod = (2**31)-1):
        self.n = n
        self.seed = seed
        self.mult = mult
        self.mod = mod
...
class generate_normal():
    ...
    def get_bm_normals(self):
        u1 = generate_uniforms(n = self.n, seed = self.seed, mult = self.unif_mult, mod = self.unif_mod)
        u2 = generate_uniforms(n = self.n, seed = self.seed, mult = self.unif_mult, mod = self.unif_mod)
